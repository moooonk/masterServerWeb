...
public class Login extends HttpServlet {
	...
	private boolean checkUserLogin(String name, String password) {
		if (name != null && password != null
				&& CoreConfig.instance.getConfig().loginName().equals(name)
				&& CoreConfig.instance.getConfig().loginPassword().equals(password)) {
			return true;
		} else {
			return false;
		}
